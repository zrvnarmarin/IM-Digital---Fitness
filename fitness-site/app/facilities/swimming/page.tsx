...
export const LongParagraphsSection = () => {
  return (
    <SectionWrapper>
      <div className="flex flex-col ">
        <p className="text-above-heading text-start">Assets</p>
        <h2 className="h2">Schedule Of Water training</h2>
      </div>
      <div className="flex flex-col gap-8">
        ...
        <div className="w-full grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-6">
          <Image src={TestImage} alt="nesto" width={0} height={0} />
          <Image src={TestImage} alt="nesto" width={0} height={0} />
          <Image src={TestImage} alt="nesto" width={0} height={0} />
          <Image src={TestImage} alt="nesto" width={0} height={0} />
        </div>
...
export function SwimmingBenefits() {
  return (
    <SectionWrapper>
      <h2 className="h2">Rip all the benefits</h2>
    ...
    >
      <div className="flex flex-row md:flex-col gap-4 items-center md:items-start">
        <div className="bg-gradient-to-r from-[#1D7349] to-[#31C57D] rounded-md p-2 w-fit">
          <TestIconTwo height="2m" width="2em" iconFill="#ffffff" />
        </div>
