...
export function HeroSection({ massageTypeTitle }: { massageTypeTitle: string }) {
  return (
    <SectionWrapper>
      ...
      <ul className="grid grid-cols-1 lg:grid-cols-1 gap-6">
        <li className={`grid grid-cols-1 md:grid-cols-2 gap-6`}>
          ...
          <div className="order-2 relative group flex flex-col gap-4 p-6 rounded-lg bg-gradient-to-r from-[#101010] to-[#191919] border-y border-[#292929]">
            ...
            <p className="normal-case text-md md:text-md text-gray-300 leading-2">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, quo veritatis perferendis fugit repellat unde. <br />
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, quo veritatis perferendis fugit repellat unde. <br /> <br />
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, quo veritatis perferendis fugit repellat unde. <br /> <br />
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, quo veritatis perferendis fugit repellat unde. 
            </p>
            </div>
          </div>
        ...
        <div className="flex-grow">
          <div className="grid grid-cols-3 gap-6">
            {otherMassageTypes.map(otherMassageType =>
                <OtherMassageTypeCard key={otherMassageType.id} otherMassageType={otherMassageType} />
            )}
          </div>
        </div>
      </div>
...
export function OtherMassageTypeCard({ otherMassageType } : { otherMassageType: OtherMassageType}) {
  return (
    <div
