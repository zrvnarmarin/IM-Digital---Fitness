...
export default function HeroSection() {
  return (
    <>
      ...
      <section className='px-6 md:px-8 lg:px-24 pl-8 py-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12'>
...
export function ProgramCard({ program, isLastItem }: { program: Program; isLastItem?: boolean }) {
  const cardClass = `flex flex-col gap-8 rounded-xl p-6 bg-[#1F2125] hover:scale-105 hover:bg-[#35373B] hover:outline-2 focus:outline-2 outline-[#1D7349] cursor-pointer ${isLastItem ? 'col-span-full' : ''}`;
