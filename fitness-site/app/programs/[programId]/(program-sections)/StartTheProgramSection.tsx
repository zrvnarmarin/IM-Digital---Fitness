            ...
            <div className="flex flex-row items-center justify-center gap-6">
              <div className="rounded-lg p-6 bg-gradient-to-r from-[#101010] to-[#161616] border border-[#292929]">
                ...
                <div className="flex flex-col gap-2 items-center text-white">
                  <h2 className="w-full text-xl md:text-xl lg:text-3xl tracking-normal text-center text-white leading-7 font-bold">Monthly</h2>
                  <p className="text-[#31C57D] text-2xl tracking-normal text-start font-semibold">$ 9.99/ MONTH</p>
                  <p className="w-full text-xl pt-2 md:text-md lg:text-lg tracking-normal text-center text-white leading-7 font-semibold uppercase">Billed $9.99 Monthly.</p>
