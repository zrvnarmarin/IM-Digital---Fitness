  ...
  return (
    <section className='px-6 md:px-8 lg:px-24 py-24 relative w-full'>
      ...
      <h1 className='flex flex-col gap-4 justify-center items-center relative'>
        ...
        <span className='z-10 text-[#FFFFFF] opacity-100 text-6xl md:text-8xl lg:text-9xl uppercase font-black'>Fitness</span>
      </h1>
      <p className='text-[#DCEAE3] text-md md:text-xl lg:text-2xl text-end font-semibold z-20'>Grow Body</p>
